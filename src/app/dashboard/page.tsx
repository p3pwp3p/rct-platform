          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
            ...
            <div className="home-card" style={{ padding: '18px 20px', display: 'flex', flexDirection: 'column', gap: 14 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Link href="/dashboard/legs" style={{ fontFamily: 'var(--font-main)', fontSize: 12, color: 'var(--accent-blue)', textDecoration: 'none' }}>트리 보기 →</Link>
              </div>
        ...
        <aside className="home-scroll" style={{
          ...
          <div style={{ padding: '22px 20px 0', flex: 1 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
              ...
              <Link href="/dashboard/legs" style={{ fontFamily: 'var(--font-main)', fontSize: 12, color: 'var(--accent-blue)', textDecoration: 'none' }}>
                전체 →
              </Link>
            </div>
