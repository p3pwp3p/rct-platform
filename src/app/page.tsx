      ...
      <section className="lp-hero">
        ...
        <div className="lp-hero-grid">
          ...
          <div className="lp-canvas">
            ...
            <div className="lp-butterfly"><ButterflyCanvas /></div>
          </div>
        </div>
      </section>
...
/* 3D 네트워크 씬 */
.lp-canvas { position:relative; min-height:520px; }
.lp-butterfly { position:relative; z-index:2; width:100%; height:560px; }
